...
local keymaps = {
  lsp = {
    n = {
      ...
      ['K'] = { '<CMD>lua vim.lsp.buf.hover()<CR>', '[LSP]: Get variable info' },
  ...
  terminal = {
    ...
    normal = {
      n = {
        ['<C-t>'] = { '<cmd>:ToggleTerm direction=horizontal<CR>', 'Terminal: Open horizontal'},
  ...
  telescope = {
    n = {
      ['<leader>ff'] = { '<cmd>lua require("telescope.builtin").find_files()<cr>', 'Telescope: Find files' },
      ['<leader>fg'] = { '<cmd>lua require("telescope.builtin").live_grep()<cr>', 'Telescope: Find grep' },
      ['<leader>fb'] = { '<cmd>lua require("telescope.builtin").buffers()<cr>', 'Telescope: Find buffers' },
  ...
  neotree = {
    n = {
      ['<C-n>'] = { '<cmd>NeoTreeFocusToggle<cr>', 'File explore: Neotree toggle' },
    }
  },
